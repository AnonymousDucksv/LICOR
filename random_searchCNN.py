...
datasets = ['blink_EEG','helix_matching_random_amp_feat_time'] #'circles','moons','helix_1_start','helix_2_start','helix_1_random_time','helix_2_random_time','helix_random_feat_random_time','helix_matching_random_amp_feat_time', 'helix_matching_random_amp_feat_time_no_phase'
N_TRIALS = 50
EX_PER_TRIAL = 2
dataset_model = ""
...
def build_model(hp):
    ...
    size_time_kernel = hp.Int("size_time_kernel", min_value=3, max_value=30, step=1)
    n_kernels = hp.Int("n_kernels", min_value=16, max_value=128, step=16)
    ...
    neurons_l3 = hp.Int("neurons_l3", min_value=10, max_value=200, step=10)

    hidden_layers_sizes = (neurons_l1,neurons_l2,neurons_l3)
    activations = 'relu'
...
for data_str in datasets: 
    ...
    results.loc[data_str,'params'] = [{'solver': 'adam',
                                    'hidden_layers_sizes': (bestParams['neurons_l1'],bestParams['neurons_l2'],bestParams['neurons_l1']),
